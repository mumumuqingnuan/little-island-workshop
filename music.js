(() => {
  'use strict';
  const musicURL = new URL('island-letter-v1.m4a', document.currentScript.src).href;
  ...
  function update() {
    ...
    status.textContent = failed ? '音乐暂未加载，请点击重试' : loading ? '配乐加载中，小岛可以继续玩' : playing ? '海风捎来的信 · 正在播放' : '海风捎来的信 · 原创配乐';
  }
