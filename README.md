...
网页左下角的“开启音乐”播放《微风卡农》：以卡农的 D–A–Bm–F♯m–G–D–G–A 和声及下行主题重新编排的轻柔变奏。4/4 拍、66 BPM，以轻钢琴分解和弦为主，长笛交替呼应，柔和弦乐延长音托底；约 1 分 56 秒，循环播放。

音乐首次点击后才请求音频；默认音量为 35%，支持关闭和调节音量，音量偏好保存在本机。切走网页时暂停，回来后尝试恢复。浏览器若阻止恢复，可再次点击开启音乐。部署时需同时保留根目录的 `music.js`、`music.css` 和 `island-canon-v2.m4a`。
