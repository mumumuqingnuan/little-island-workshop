...
网页左下角的“开启音乐”播放原创曲目《海风捎来的信》：G 大调、3/4 拍、78 BPM，以钢琴分解和弦、长笛旋律、轻弦乐和尼龙吉他营造温馨小镇的氛围。曲目约 1 分 51 秒，循环播放。

音乐首次点击后才请求音频；默认音量为 35%，支持关闭和调节音量，音量偏好保存在本机。切走网页时暂停，回来后尝试恢复。浏览器若阻止恢复，可再次点击开启音乐。部署时需同时保留根目录的 `music.js`、`music.css` 和 `island-letter-v1.m4a`。
