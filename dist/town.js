...
import {material,seasonal,mesh,box,sphere,cylinder,cone,beam,group,roof,windowFrame,door,flowers,fence,tree,lamp,trimBox,compact,snow,animateModel,applySeason} from './models.js?v=18';
import {cloth,lantern,stall,animateCloth} from './life.js?v=18';
import {resident,animateResident,poseFishing,routePosition,strollResident} from './residents.js?v=18';
